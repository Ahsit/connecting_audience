...
class Sharechat extends StatefulWidget {
  ...
  @override
  State<Sharechat> createState() => _SharechatState();
}
                          ...
                          Padding(
                            ...
                            child: Expanded(
                              child: RichText(
                                text: const TextSpan(
                                  text:
                                      'Local and online businesses alike can achieve these goals by having an effective Sharechat for business strategy.',
                                  style: TextStyle(
                                      color: Pallete.black,
                                      fontSize: 13,
