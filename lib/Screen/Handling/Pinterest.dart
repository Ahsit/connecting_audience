...
class Pinterest extends StatefulWidget {
  ...
  @override
  State<Pinterest> createState() => _PinterestState();
}
                        ...
                        Padding(
                          ...
                          child: Expanded(
                            child: RichText(
                              text: const TextSpan(
                                text:
                                    'Local and online businesses alike can achieve these goals by having an effective Pinterest for business strategy.',
                                style: TextStyle(
                                    color: Pallete.black,
                                    fontSize: 13,
