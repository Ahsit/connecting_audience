...
class instagramads extends StatefulWidget {
  const instagramads({super.key});

  @override
  State<instagramads> createState() => _instagramadsState();
}

class _instagramadsState extends State<instagramads> {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/ads/insta.png'))),
                        )),
                    Padding(
                        ...
                        Padding(
                          ...
                          child: Expanded(
                            child: RichText(
                              text: const TextSpan(
                                text:
                                    'Instagram marketing drives brand awareness, boosts sales and expands product visibility. Does Instagram marketing really work? ',
                                style: TextStyle(
                                    color: Pallete.black,
                                    fontSize: 13,
