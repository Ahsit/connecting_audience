...
class linkedinads extends StatefulWidget {
  const linkedinads({super.key});

  @override
  State<linkedinads> createState() => _linkedinadsState();
}

class _linkedinadsState extends State<linkedinads> {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image:
                                      AssetImage('assets/ads/linkedin.png'))),
                        )),
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image:
                                    AssetImage('assets/ads/rectangle1.png'))),
                      ),
                    ),
                    Padding(
                        ...
                        Padding(
                          ...
                          child: Expanded(
                            child: RichText(
                              text: const TextSpan(
                                text:
                                    'A unique and stunning Linkedin Ads Service and stands out from the crowd. Deliver unique and visually stunning high-quality experience for viewers ',
                                style: TextStyle(
                                    color: Pallete.black,
                                    fontSize: 13,
