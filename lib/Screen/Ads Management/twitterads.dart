...
class twitterads extends StatefulWidget {
  const twitterads({super.key});

  @override
  State<twitterads> createState() => _twitteradsState();
}

class _twitteradsState extends State<twitterads> {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/ads/twitter.png'))),
                        )),
                    Padding(
                        ...
                        Padding(
                          ...
                          child: Expanded(
                            child: RichText(
                              text: const TextSpan(
                                text:
                                    'Are you satisfied with the results you’re getting from your Twitter Ads? Do you want to increase your followers ',
                                style: TextStyle(
                                    color: Pallete.black,
                                    fontSize: 13,
