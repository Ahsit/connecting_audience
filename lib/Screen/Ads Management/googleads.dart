                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/ads/google.png'))),
                        )),
                    Padding(
                        ...
                        Padding(
                          ...
                          child: Expanded(
                            child: RichText(
                              text: const TextSpan(
                                text:
                                    'Get in front of customers when they’re searching for businesses like yours on Google Search and Maps. Only pay for results ',
                                style: TextStyle(
                                    color: Pallete.black,
                                    fontSize: 13,
