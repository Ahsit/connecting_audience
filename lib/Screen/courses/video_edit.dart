...
class VideoEd extends StatelessWidget {
  const VideoEd({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              const Padding(
                ...
                child: Image(image: AssetImage('assets/service7.png')),
              ),
              Container(
                  height: 600,
                  width: width * 0.9,
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(' Video Editing Courses ',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 21,
                      ...
                      Row(
                        children: const [
                          Expanded(
                            ...
                            child: Text(
                                'Learn Beginner-Advanced Adobe Premiere Pro Video Editing, Audio Editing, Color Grading, Motion Graphics, Green Screen+ we’ll be here for you every step of the way.',
                                style: TextStyle(
                                    fontSize: 16,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: const [
                            Expanded(
                                child: Text('What you learn in Video Editing?',
                                    style: TextStyle(
                                        fontSize: 17,
