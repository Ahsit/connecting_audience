...
class StrategyMarket extends StatelessWidget {
  const StrategyMarket({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              const Padding(
                ...
                child: Image(image: AssetImage('assets/service5.png')),
              ),
              Container(
                  height: 600,
                  width: width * 0.9,
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(' Marketing Management Courses',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 21,
