...
class ServiceGraphic extends StatefulWidget {
  const ServiceGraphic({super.key});

  @override
  State<ServiceGraphic> createState() => _ServiceGraphicState();
}

class _ServiceGraphicState extends State<ServiceGraphic> {
  DateTime selectedDate = DateTime.now();
  double _sliderValue = 0.0;
  int _currentIndex = 0;
  final List<String> photos = [
    'assets/service/graphicdesign.png',
    'assets/service/graphicdesign.png'
        'assets/service/graphicdesign.png'
        'assets/service/graphicdesign.png'
  ];
