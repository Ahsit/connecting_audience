...
class ServiceAdsManage extends StatefulWidget {
  const ServiceAdsManage({super.key});

  @override
  State<ServiceAdsManage> createState() => _ServiceAdsManageState();
}

class _ServiceAdsManageState extends State<ServiceAdsManage> {
  DateTime selectedDate = DateTime.now();
  double _sliderValue = 0.0;
  int _currentIndex = 0;
  final List<String> photos = [
    'assets/service/adsmanage.png',
    'assets/service/adsmanage.png',
    'assets/service/adsmanage.png',
    'assets/service/adsmanage.png',
  ];
                        ...
                        builder: (BuildContext context) {
                          return Container(
                            margin: EdgeInsets.symmetric(
                                horizontal:
                                    5), // Added margin for partial visibility
                            child: ClipRRect(
