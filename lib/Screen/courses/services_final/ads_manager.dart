...
class ServiceAdsManager extends StatefulWidget {
  const ServiceAdsManager({super.key});

  @override
  State<ServiceAdsManager> createState() => _ServiceAdsManagerState();
}

class _ServiceAdsManagerState extends State<ServiceAdsManager> {
  DateTime selectedDate = DateTime.now();
  double _sliderValue = 0.0;
  int _currentIndex = 0;
  final List<String> photos = [
    'assets/service/adsmanager.png',
    'assets/service/adsmanager.png',
    'assets/service/adsmanager.png',
    'assets/service/adsmanager.png',
  ];
