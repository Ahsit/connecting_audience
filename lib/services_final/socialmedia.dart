// ignore_for_file: camel_case_types, curly_braces_in_flow_control_structures, prefer_const_constructors
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(top: 16.0, left: 20, right: 32),
                    child: Expanded(
                      child: RichText(
                        text: const TextSpan(
                          text:
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(left: 30.0, right: 30, top: 49),
                    child: Container(
                      height: 47,
                      width: 362,
                  ...
                  const Padding(
                    padding: EdgeInsets.only(left: 34.0, top: 10, right: 33),
                    child: Expanded(
                      child: Text(
